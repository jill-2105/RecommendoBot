package com.recommendobot.algorithms.searchfrequency;
import java.io.*;
import java.util.*;
...
//        }
    ...
    // Add a word with a specific initial count (used by FrequencyService when loading DB rows)
    public void addSearchedWord(String word, int initialCount) {
        if (initialCount <= 0) return;
        // Simple approach: increment the word count initialCount times
    ...
    // Return top N searched words as list of strings (most frequent first)
